...
char* generate_sandbox_extensions(audit_token_t *processToken, bool writable)
{
	...
	char *readExtension = sandbox_extension_issue_file_to_process("com.apple.app-sandbox.read", jbroot("/"), 0, *processToken);
	// char *execExtension = sandbox_extension_issue_file_to_process("com.apple.sandbox.executable", jbrootbase, 0, *processToken);
	char *execExtension = sandbox_extension_issue_file_to_process("com.apple.sandbox.executable", jbroot("/"), 0, *processToken);
	char *readExtension2 = sandbox_extension_issue_file_to_process("com.apple.app-sandbox.read-write", jbroot("/var/mobile"), 0, *processToken);
